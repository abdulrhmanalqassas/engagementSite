...
export default memo(function FloralDecoration() {
  return (
    <div className="fixed top-0 left-0 right-0 pointer-events-none z-[999]" style={{ marginTop: '60px' }}>
      <svg viewBox="0 0 1200 120" className="w-full h-28" xmlns="http://www.w3.org/2000/svg">
        <path className="anim-sway" d="M0,60 Q100,40 200,55 Q300,70 400,55 Q500,40 600,55 Q700,70 800,55 Q900,40 1000,55 Q1100,70 1200,55" stroke="#4A5568" fill="none" strokeWidth="2.5" opacity="0.5"/>
